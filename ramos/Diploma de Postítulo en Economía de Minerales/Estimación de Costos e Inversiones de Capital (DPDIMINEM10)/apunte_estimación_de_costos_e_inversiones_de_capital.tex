...
% --- Datos del documento ---
\title{Estimación de Costos e Inversiones de Capital}
...
Este documento contiene los apuntes del ramo Estimación de Costos e Inversiones de Capital (DPDIMINEM10).
