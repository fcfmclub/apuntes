...
% --- Datos del documento ---
\title{Valorización, Fusiones y Adquisiciones de Empresas}
...
Este documento contiene los apuntes del ramo Valorización, Fusiones y Adquisiciones de Empresas (DPDIIDFVFA05).
