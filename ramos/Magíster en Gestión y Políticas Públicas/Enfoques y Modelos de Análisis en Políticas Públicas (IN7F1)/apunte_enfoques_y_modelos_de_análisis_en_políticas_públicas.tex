...
% --- Datos del documento ---
\title{Enfoques y Modelos de Análisis en Políticas Públicas}
...
Este documento contiene los apuntes del ramo Enfoques y Modelos de Análisis en Políticas Públicas (IN7F1).
