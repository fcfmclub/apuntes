...
% --- Datos del documento ---
\title{Aspectos Legales en la Administración de Contratos}
...
Este documento contiene los apuntes del ramo Aspectos Legales en la Administración de Contratos (DPDIIACWK09).
