...
% --- Datos del documento ---
\title{Negociación en la Administración de Contratos}
...
Este documento contiene los apuntes del ramo Negociación en la Administración de Contratos (DPDIIACWK08).
