...
% --- Datos del documento ---
\title{Seminario 2: Desafíos en los Proyectos Ferroviarios y de Metro}
...
Este documento contiene los apuntes del ramo Seminario 2: Desafíos en los Proyectos Ferroviarios y de Metro (DPDICPFM12).
