...
% --- Datos del documento ---
\title{Trenes y Sistemas en Proyectos Ferroviarios y de Metro}
...
Este documento contiene los apuntes del ramo Trenes y Sistemas en Proyectos Ferroviarios y de Metro (DPDICPFM07).
