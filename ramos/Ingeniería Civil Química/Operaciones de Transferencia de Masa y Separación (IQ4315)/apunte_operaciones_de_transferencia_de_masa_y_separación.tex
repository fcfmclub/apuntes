...
% --- Datos del documento ---
\title{Operaciones de Transferencia de Masa y Separación}
...
Este documento contiene los apuntes del ramo Operaciones de Transferencia de Masa y Separación (IQ4315).
