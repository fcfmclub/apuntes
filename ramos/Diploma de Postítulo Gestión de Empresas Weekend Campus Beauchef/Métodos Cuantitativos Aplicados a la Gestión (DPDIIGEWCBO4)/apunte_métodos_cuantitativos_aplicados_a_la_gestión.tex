...
% --- Datos del documento ---
\title{Métodos Cuantitativos Aplicados a la Gestión}
...
Este documento contiene los apuntes del ramo Métodos Cuantitativos Aplicados a la Gestión (DPDIIGEWCBO4).
