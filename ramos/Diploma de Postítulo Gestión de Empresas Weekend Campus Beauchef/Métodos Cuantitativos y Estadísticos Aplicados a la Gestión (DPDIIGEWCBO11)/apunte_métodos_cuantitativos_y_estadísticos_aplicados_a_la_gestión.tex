...
% --- Datos del documento ---
\title{Métodos Cuantitativos y Estadísticos Aplicados a la Gestión}
...
Este documento contiene los apuntes del ramo Métodos Cuantitativos y Estadísticos Aplicados a la Gestión (DPDIIGEWCBO11).
