...
% --- Datos del documento ---
\title{Monitoreo de Señales y Detección de Anomalías}
...
Este documento contiene los apuntes del ramo Monitoreo de Señales y Detección de Anomalías (DPDIMCMG19).
