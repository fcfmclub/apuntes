...
% --- Datos del documento ---
\title{Confiabilidad Humana en la Gestión de Activos}
...
Este documento contiene los apuntes del ramo Confiabilidad Humana en la Gestión de Activos (DPDIMCMG09).
