...
% --- Datos del documento ---
\title{Auditor Líder de Sistema de Gestión Integrado}
...
Este documento contiene los apuntes del ramo Auditor Líder de Sistema de Gestión Integrado (DDPECSIG04).
