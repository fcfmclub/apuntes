...
% --- Datos del documento ---
\title{Dinámica de Estructuras y Monitoreo de Estructuras}
...
Este documento contiene los apuntes del ramo Dinámica de Estructuras y Monitoreo de Estructuras (DPDICIEDS02).
