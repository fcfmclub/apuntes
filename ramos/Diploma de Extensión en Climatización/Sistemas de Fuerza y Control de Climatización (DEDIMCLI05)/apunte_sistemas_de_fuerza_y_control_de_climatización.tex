...
% --- Datos del documento ---
\title{Sistemas de Fuerza y Control de Climatización}
...
Este documento contiene los apuntes del ramo Sistemas de Fuerza y Control de Climatización (DEDIMCLI05).
