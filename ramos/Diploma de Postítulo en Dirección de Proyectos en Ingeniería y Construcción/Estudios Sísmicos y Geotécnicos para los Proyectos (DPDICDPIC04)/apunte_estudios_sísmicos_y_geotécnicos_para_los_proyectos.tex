...
% --- Datos del documento ---
\title{Estudios Sísmicos y Geotécnicos para los Proyectos}
...
Este documento contiene los apuntes del ramo Estudios Sísmicos y Geotécnicos para los Proyectos (DPDICDPIC04).
