...
% --- Datos del documento ---
\title{Investigación en Ciencias de la Computación (Métodos, Técnicas, Perspectivas)}
...
Este documento contiene los apuntes del ramo Investigación en Ciencias de la Computación (Métodos, Técnicas, Perspectivas) (CC7910).
