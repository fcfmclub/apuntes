...
% --- Datos del documento ---
\title{Volcanology: Processes, Hazards and Mitigation in Crisis Context}
...
Este documento contiene los apuntes del ramo Volcanology: Processes, Hazards and Mitigation in Crisis Context (CEEPECVOLC01).
