...
% --- Datos del documento ---
\title{Internet de la Cosas (IoT) y Big Data en la Confiabilidad y Mantenimiento}
...
Este documento contiene los apuntes del ramo Internet de la Cosas (IoT) y Big Data en la Confiabilidad y Mantenimiento (DPDIMBDACM15).
