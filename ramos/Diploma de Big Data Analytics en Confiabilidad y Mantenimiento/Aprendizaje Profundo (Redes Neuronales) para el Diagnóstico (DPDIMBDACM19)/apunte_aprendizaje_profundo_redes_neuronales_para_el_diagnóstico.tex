...
% --- Datos del documento ---
\title{Aprendizaje Profundo (Redes Neuronales) para el Diagnóstico}
...
Este documento contiene los apuntes del ramo Aprendizaje Profundo (Redes Neuronales) para el Diagnóstico (DPDIMBDACM19).
