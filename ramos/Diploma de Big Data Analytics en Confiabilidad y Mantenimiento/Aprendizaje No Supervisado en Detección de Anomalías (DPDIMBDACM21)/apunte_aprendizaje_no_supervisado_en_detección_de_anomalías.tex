...
% --- Datos del documento ---
\title{Aprendizaje No Supervisado en Detección de Anomalías}
...
Este documento contiene los apuntes del ramo Aprendizaje No Supervisado en Detección de Anomalías (DPDIMBDACM21).
