...
% --- Datos del documento ---
\title{Optimización para Soporte en la Toma de Decisiones}
...
Este documento contiene los apuntes del ramo Optimización para Soporte en la Toma de Decisiones (DPDIMBDACM23).
