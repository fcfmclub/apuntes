...
% --- Datos del documento ---
\title{Transformación Digital: IoT, Cloud y Edge Computing y Sensorización en la Industria 4.0}
...
Este documento contiene los apuntes del ramo Transformación Digital: IoT, Cloud y Edge Computing y Sensorización en la Industria 4.0 (DPDIMBDACM13).
