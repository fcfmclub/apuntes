...
% --- Datos del documento ---
\title{Fundamentos de Hadoop para el Análisis de Big Data en Confiabilidad y Mantenimiento}
...
Este documento contiene los apuntes del ramo Fundamentos de Hadoop para el Análisis de Big Data en Confiabilidad y Mantenimiento (DPDIMBDACM06).
