...
% --- Datos del documento ---
\title{Instalación, Monitoreo y Control de Sistemas de Climatización}
...
Este documento contiene los apuntes del ramo Instalación, Monitoreo y Control de Sistemas de Climatización (DPDIMCLI05).
