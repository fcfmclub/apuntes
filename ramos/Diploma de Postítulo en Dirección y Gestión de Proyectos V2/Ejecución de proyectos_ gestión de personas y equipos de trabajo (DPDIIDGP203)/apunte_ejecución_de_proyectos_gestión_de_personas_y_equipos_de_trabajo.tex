...
% --- Datos del documento ---
\title{Ejecución de proyectos: gestión de personas y equipos de trabajo}
...
Este documento contiene los apuntes del ramo Ejecución de proyectos: gestión de personas y equipos de trabajo (DPDIIDGP203).
