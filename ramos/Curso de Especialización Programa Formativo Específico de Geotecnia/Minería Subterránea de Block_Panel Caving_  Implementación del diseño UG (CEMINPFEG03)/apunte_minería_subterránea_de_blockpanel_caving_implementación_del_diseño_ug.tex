...
% --- Datos del documento ---
\title{Minería Subterránea de Block/Panel Caving:  Implementación del diseño UG}
...
Este documento contiene los apuntes del ramo Minería Subterránea de Block/Panel Caving:  Implementación del diseño UG (CEMINPFEG03).
