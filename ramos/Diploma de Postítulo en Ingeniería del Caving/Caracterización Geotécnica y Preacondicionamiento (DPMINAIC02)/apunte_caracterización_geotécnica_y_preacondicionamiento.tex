...
% --- Datos del documento ---
\title{Caracterización Geotécnica y Preacondicionamiento}
...
Este documento contiene los apuntes del ramo Caracterización Geotécnica y Preacondicionamiento (DPMINAIC02).
