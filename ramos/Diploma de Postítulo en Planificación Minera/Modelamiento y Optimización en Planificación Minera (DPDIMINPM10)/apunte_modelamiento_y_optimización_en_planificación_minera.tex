...
% --- Datos del documento ---
\title{Modelamiento y Optimización en Planificación Minera}
...
Este documento contiene los apuntes del ramo Modelamiento y Optimización en Planificación Minera (DPDIMINPM10).
