...
% --- Datos del documento ---
\title{Diseño y Planificación de Minas Subterráneas}
...
Este documento contiene los apuntes del ramo Diseño y Planificación de Minas Subterráneas (DPDIMINPM04).
