...
% --- Datos del documento ---
\title{Curso de profundización y amplitud III - Ciencia de Datos Conductual}
...
Este documento contiene los apuntes del ramo Curso de profundización y amplitud III - Ciencia de Datos Conductual (ENGIN656).
