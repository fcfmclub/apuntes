...
% --- Datos del documento ---
\title{Proyecto de Sistemas Hidráulicos Sanitarios y Ambientales}
...
Este documento contiene los apuntes del ramo Proyecto de Sistemas Hidráulicos Sanitarios y Ambientales (CI5261).
