...
% --- Datos del documento ---
\title{Gestión de Contratos de Servicios y Taller de Casos}
...
Este documento contiene los apuntes del ramo Gestión de Contratos de Servicios y Taller de Casos (DPDIMEOGA09).
