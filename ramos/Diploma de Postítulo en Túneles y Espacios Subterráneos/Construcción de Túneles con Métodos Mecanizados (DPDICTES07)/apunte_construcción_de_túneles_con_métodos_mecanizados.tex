...
% --- Datos del documento ---
\title{Construcción de Túneles con Métodos Mecanizados}
...
Este documento contiene los apuntes del ramo Construcción de Túneles con Métodos Mecanizados (DPDICTES07).
