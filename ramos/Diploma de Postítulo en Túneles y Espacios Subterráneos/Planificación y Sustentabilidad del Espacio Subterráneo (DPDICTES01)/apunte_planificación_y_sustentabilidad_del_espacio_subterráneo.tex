...
% --- Datos del documento ---
\title{Planificación y Sustentabilidad del Espacio Subterráneo}
...
Este documento contiene los apuntes del ramo Planificación y Sustentabilidad del Espacio Subterráneo (DPDICTES01).
