...
% --- Datos del documento ---
\title{Principios y Metodologías de Intervención de Lean Management}
...
Este documento contiene los apuntes del ramo Principios y Metodologías de Intervención de Lean Management (CEDIIPFEO02).
