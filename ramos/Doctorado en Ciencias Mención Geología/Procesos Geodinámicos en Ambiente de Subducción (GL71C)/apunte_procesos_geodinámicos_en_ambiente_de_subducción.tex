...
% --- Datos del documento ---
\title{Procesos Geodinámicos en Ambiente de Subducción}
...
Este documento contiene los apuntes del ramo Procesos Geodinámicos en Ambiente de Subducción (GL71C).
