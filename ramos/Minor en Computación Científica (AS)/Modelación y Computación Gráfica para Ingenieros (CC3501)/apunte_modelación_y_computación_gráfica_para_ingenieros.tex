...
% --- Datos del documento ---
\title{Modelación y Computación Gráfica para Ingenieros}
...
Este documento contiene los apuntes del ramo Modelación y Computación Gráfica para Ingenieros (CC3501).
