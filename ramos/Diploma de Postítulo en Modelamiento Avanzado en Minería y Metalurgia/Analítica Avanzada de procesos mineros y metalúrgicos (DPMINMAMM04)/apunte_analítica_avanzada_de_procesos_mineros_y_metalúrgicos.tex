...
% --- Datos del documento ---
\title{Analítica Avanzada de procesos mineros y metalúrgicos}
...
Este documento contiene los apuntes del ramo Analítica Avanzada de procesos mineros y metalúrgicos (DPMINMAMM04).
