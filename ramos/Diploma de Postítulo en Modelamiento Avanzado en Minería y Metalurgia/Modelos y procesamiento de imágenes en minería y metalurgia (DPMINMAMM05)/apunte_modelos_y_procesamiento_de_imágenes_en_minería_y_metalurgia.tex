...
% --- Datos del documento ---
\title{Modelos y procesamiento de imágenes en minería y metalurgia}
...
Este documento contiene los apuntes del ramo Modelos y procesamiento de imágenes en minería y metalurgia (DPMINMAMM05).
