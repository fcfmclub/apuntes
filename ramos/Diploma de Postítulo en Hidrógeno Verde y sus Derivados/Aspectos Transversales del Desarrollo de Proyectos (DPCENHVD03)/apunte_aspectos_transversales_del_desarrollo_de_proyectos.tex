...
% --- Datos del documento ---
\title{Aspectos Transversales del Desarrollo de Proyectos}
...
Este documento contiene los apuntes del ramo Aspectos Transversales del Desarrollo de Proyectos (DPCENHVD03).
