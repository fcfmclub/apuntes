...
% --- Datos del documento ---
\title{M3  Gobernanza del cambio climático para la mitigación y adaptación}
...
Este documento contiene los apuntes del ramo M3  Gobernanza del cambio climático para la mitigación y adaptación (DPDIECCDBC06).
