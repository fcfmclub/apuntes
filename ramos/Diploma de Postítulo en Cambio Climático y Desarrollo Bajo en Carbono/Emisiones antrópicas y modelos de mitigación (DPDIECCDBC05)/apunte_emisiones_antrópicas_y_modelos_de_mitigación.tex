...
% --- Datos del documento ---
\title{Emisiones antrópicas y modelos de mitigación}
...
Este documento contiene los apuntes del ramo Emisiones antrópicas y modelos de mitigación (DPDIECCDBC05).
