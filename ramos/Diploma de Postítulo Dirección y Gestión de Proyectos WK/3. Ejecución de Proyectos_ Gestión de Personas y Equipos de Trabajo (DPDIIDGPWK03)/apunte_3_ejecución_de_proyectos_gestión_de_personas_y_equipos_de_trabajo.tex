...
% --- Datos del documento ---
\title{3. Ejecución de Proyectos: Gestión de Personas y Equipos de Trabajo}
...
Este documento contiene los apuntes del ramo 3. Ejecución de Proyectos: Gestión de Personas y Equipos de Trabajo (DPDIIDGPWK03).
