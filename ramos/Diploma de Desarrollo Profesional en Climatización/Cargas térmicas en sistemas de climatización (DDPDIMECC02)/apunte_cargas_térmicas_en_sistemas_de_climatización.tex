...
% --- Datos del documento ---
\title{Cargas térmicas en sistemas de climatización}
...
Este documento contiene los apuntes del ramo Cargas térmicas en sistemas de climatización (DDPDIMECC02).
