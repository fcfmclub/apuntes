...
% --- Datos del documento ---
\title{Introducción: Fundamentos Térmicos de Climatización}
...
Este documento contiene los apuntes del ramo Introducción: Fundamentos Térmicos de Climatización (DDPDIMECC01).
