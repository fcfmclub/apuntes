...
% --- Datos del documento ---
\title{Modelos de Yacimientos/ Evaluación de Recursos}
...
Este documento contiene los apuntes del ramo Modelos de Yacimientos/ Evaluación de Recursos (DPDIMINGMM12).
