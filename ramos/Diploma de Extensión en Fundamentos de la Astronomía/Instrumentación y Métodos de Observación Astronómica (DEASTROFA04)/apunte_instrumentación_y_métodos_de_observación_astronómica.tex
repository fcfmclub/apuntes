...
% --- Datos del documento ---
\title{Instrumentación y Métodos de Observación Astronómica}
...
Este documento contiene los apuntes del ramo Instrumentación y Métodos de Observación Astronómica (DEASTROFA04).
