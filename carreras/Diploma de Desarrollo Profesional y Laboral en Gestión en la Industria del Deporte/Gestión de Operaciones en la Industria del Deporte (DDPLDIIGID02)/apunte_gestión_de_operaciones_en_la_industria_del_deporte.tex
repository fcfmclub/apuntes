...
% --- Datos del documento ---
\title{Gestión de Operaciones en la Industria del Deporte}
...
Este documento contiene los apuntes del ramo Gestión de Operaciones en la Industria del Deporte (DDPLDIIGID02).
