...
% --- Datos del documento ---
\title{Construcción de Túneles con Métodos Convencionales}
...
Este documento contiene los apuntes del ramo Construcción de Túneles con Métodos Convencionales (DPDICTES05).
