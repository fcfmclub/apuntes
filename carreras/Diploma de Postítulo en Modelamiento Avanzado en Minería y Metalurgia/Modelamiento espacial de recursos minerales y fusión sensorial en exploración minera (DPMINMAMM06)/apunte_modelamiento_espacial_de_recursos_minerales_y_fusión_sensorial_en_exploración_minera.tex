...
% --- Datos del documento ---
\title{Modelamiento espacial de recursos minerales y fusión sensorial en exploración minera}
...
Este documento contiene los apuntes del ramo Modelamiento espacial de recursos minerales y fusión sensorial en exploración minera (DPMINMAMM06).
