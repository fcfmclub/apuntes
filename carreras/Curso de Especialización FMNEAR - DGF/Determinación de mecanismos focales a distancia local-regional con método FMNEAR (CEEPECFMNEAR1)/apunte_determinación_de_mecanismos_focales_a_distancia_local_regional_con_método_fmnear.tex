...
% --- Datos del documento ---
\title{Determinación de mecanismos focales a distancia local-regional con método FMNEAR}
...
Este documento contiene los apuntes del ramo Determinación de mecanismos focales a distancia local-regional con método FMNEAR (CEEPECFMNEAR1).
