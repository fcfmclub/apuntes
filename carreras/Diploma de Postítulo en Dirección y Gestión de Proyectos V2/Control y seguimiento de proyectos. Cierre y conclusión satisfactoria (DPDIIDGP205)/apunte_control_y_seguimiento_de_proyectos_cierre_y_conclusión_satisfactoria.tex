...
% --- Datos del documento ---
\title{Control y seguimiento de proyectos. Cierre y conclusión satisfactoria}
...
Este documento contiene los apuntes del ramo Control y seguimiento de proyectos. Cierre y conclusión satisfactoria (DPDIIDGP205).
