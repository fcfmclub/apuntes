...
% --- Datos del documento ---
\title{Gestión de proyectos de negocio y emprendimiento}
...
Este documento contiene los apuntes del ramo Gestión de proyectos de negocio y emprendimiento (DPDIIDGP207).
