...
% --- Datos del documento ---
\title{Introducción a Large Language Models (LLM) en Mantenimiento Predictivo}
...
Este documento contiene los apuntes del ramo Introducción a Large Language Models (LLM) en Mantenimiento Predictivo (DPMECIACM11).
