...
% --- Datos del documento ---
\title{Marco Legal para la Aplicación de un Sistema Integrado de Gestión}
...
Este documento contiene los apuntes del ramo Marco Legal para la Aplicación de un Sistema Integrado de Gestión (DDPECSIG02).
