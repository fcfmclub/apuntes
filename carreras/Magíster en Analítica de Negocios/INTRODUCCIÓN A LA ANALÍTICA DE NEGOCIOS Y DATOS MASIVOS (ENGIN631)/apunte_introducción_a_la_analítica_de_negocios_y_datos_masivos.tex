...
% --- Datos del documento ---
\title{INTRODUCCIÓN A LA ANALÍTICA DE NEGOCIOS Y DATOS MASIVOS}
...
Este documento contiene los apuntes del ramo INTRODUCCIÓN A LA ANALÍTICA DE NEGOCIOS Y DATOS MASIVOS (ENGIN631).
