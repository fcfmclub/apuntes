...
% --- Datos del documento ---
\title{Computación en la Nube: Despliegue de Soluciones Predictivas}
...
Este documento contiene los apuntes del ramo Computación en la Nube: Despliegue de Soluciones Predictivas (DPDIMBDACM24).
