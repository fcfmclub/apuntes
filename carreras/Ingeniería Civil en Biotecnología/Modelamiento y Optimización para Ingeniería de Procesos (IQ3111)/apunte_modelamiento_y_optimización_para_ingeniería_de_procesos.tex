...
% --- Datos del documento ---
\title{Modelamiento y Optimización para Ingeniería de Procesos}
...
Este documento contiene los apuntes del ramo Modelamiento y Optimización para Ingeniería de Procesos (IQ3111).
