...
% --- Datos del documento ---
\title{Indicadores y KPI en la Administración de Contratos}
...
Este documento contiene los apuntes del ramo Indicadores y KPI en la Administración de Contratos (DPDIIACWK04).
