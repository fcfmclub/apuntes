...
% --- Datos del documento ---
\title{Módulo Articulador (Introducción, Charlas y Caso)}
...
Este documento contiene los apuntes del ramo Módulo Articulador (Introducción, Charlas y Caso) (DPDIIACWK01).
