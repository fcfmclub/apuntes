...
% --- Datos del documento ---
\title{Laboratorio de Programación Científica para Ciencia de Datos}
...
Este documento contiene los apuntes del ramo Laboratorio de Programación Científica para Ciencia de Datos (MDS7202).
