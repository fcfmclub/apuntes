...
% --- Datos del documento ---
\title{Análisis de Datos Aplicada a la Gestión de Activos}
...
Este documento contiene los apuntes del ramo Análisis de Datos Aplicada a la Gestión de Activos (DPDIMCMG07).
