...
% --- Datos del documento ---
\title{M2 Mitigación y  Modelación de Políticas Climáticas}
...
Este documento contiene los apuntes del ramo M2 Mitigación y  Modelación de Políticas Climáticas (DPDIECCDBC02).
