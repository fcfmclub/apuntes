...
% --- Datos del documento ---
\title{Una Gobernanza resiliente para el cambio climático en Chile}
...
Este documento contiene los apuntes del ramo Una Gobernanza resiliente para el cambio climático en Chile (DPDIECCDBC03).
