...
% --- Datos del documento ---
\title{Escuela de Invierno en Geociencias Integradas para la Minería}
...
Este documento contiene los apuntes del ramo Escuela de Invierno en Geociencias Integradas para la Minería (CEMINEIGIM01).
