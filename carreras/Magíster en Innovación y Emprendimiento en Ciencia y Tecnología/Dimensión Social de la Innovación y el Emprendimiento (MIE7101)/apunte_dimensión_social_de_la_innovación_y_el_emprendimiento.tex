...
% --- Datos del documento ---
\title{Dimensión Social de la Innovación y el Emprendimiento}
...
Este documento contiene los apuntes del ramo Dimensión Social de la Innovación y el Emprendimiento (MIE7101).
