...
% --- Datos del documento ---
\title{Formulación y Evaluación Social de Proyectos CERRO NAVIA}
...
Este documento contiene los apuntes del ramo Formulación y Evaluación Social de Proyectos CERRO NAVIA (CECSPFESP02).
