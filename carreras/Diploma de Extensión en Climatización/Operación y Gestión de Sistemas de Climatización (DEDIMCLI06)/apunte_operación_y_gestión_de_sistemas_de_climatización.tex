...
% --- Datos del documento ---
\title{Operación y Gestión de Sistemas de Climatización}
...
Este documento contiene los apuntes del ramo Operación y Gestión de Sistemas de Climatización (DEDIMCLI06).
