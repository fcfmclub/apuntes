...
% --- Datos del documento ---
\title{Eficiencia Energética y Recuperación de Calor}
...
Este documento contiene los apuntes del ramo Eficiencia Energética y Recuperación de Calor (DEDIMCLI04).
