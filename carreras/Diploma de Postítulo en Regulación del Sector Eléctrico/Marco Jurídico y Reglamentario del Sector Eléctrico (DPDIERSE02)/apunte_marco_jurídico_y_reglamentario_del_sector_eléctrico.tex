...
% --- Datos del documento ---
\title{Marco Jurídico y Reglamentario del Sector Eléctrico}
...
Este documento contiene los apuntes del ramo Marco Jurídico y Reglamentario del Sector Eléctrico (DPDIERSE02).
