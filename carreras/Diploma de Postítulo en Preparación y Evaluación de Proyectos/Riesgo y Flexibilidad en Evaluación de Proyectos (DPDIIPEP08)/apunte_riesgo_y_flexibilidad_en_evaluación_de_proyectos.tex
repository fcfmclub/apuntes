...
% --- Datos del documento ---
\title{Riesgo y Flexibilidad en Evaluación de Proyectos}
...
Este documento contiene los apuntes del ramo Riesgo y Flexibilidad en Evaluación de Proyectos (DPDIIPEP08).
