...
% --- Datos del documento ---
\title{Análisis Estadístico de Datos-Evaluación de Recursos y Reservas}
...
Este documento contiene los apuntes del ramo Análisis Estadístico de Datos-Evaluación de Recursos y Reservas (DPDIMINGMM14).
