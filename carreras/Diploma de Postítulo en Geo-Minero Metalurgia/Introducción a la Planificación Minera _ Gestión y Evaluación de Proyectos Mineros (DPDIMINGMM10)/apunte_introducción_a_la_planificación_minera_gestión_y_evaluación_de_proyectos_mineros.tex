...
% --- Datos del documento ---
\title{Introducción a la Planificación Minera / Gestión y Evaluación de Proyectos Mineros}
...
Este documento contiene los apuntes del ramo Introducción a la Planificación Minera / Gestión y Evaluación de Proyectos Mineros (DPDIMINGMM10).
