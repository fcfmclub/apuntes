...
% --- Datos del documento ---
\title{Análisis y Diseño de Estructuras con Sistemas de Aislación Basal}
...
Este documento contiene los apuntes del ramo Análisis y Diseño de Estructuras con Sistemas de Aislación Basal (DPDICIEDS19).
