...
% --- Datos del documento ---
\title{Caracterización geotécnica, empuje, sistemas de contención}
...
Este documento contiene los apuntes del ramo Caracterización geotécnica, empuje, sistemas de contención (DPDICIEDS11).
