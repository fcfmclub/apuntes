...
% --- Datos del documento ---
\title{Muestreo y Control de Calidad para Evaluación de Yacimientos}
...
Este documento contiene los apuntes del ramo Muestreo y Control de Calidad para Evaluación de Yacimientos (DPDIMINEG03).
