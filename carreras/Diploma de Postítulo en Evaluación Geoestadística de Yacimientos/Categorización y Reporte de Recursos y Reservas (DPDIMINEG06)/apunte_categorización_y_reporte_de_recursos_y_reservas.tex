...
% --- Datos del documento ---
\title{Categorización y Reporte de Recursos y Reservas}
...
Este documento contiene los apuntes del ramo Categorización y Reporte de Recursos y Reservas (DPDIMINEG06).
