...
% --- Datos del documento ---
\title{MÓDULO 1: Fundamentos de Infraestructura Critica Minera}
...
Este documento contiene los apuntes del ramo MÓDULO 1: Fundamentos de Infraestructura Critica Minera (DDPDICICM01).
