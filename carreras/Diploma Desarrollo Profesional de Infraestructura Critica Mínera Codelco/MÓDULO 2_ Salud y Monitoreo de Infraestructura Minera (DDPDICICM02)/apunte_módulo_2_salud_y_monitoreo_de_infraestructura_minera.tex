...
% --- Datos del documento ---
\title{MÓDULO 2: Salud y Monitoreo de Infraestructura Minera}
...
Este documento contiene los apuntes del ramo MÓDULO 2: Salud y Monitoreo de Infraestructura Minera (DDPDICICM02).
