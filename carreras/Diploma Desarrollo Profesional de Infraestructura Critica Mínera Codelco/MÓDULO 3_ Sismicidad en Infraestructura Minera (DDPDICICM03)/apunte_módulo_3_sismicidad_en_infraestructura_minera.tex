...
% --- Datos del documento ---
\title{MÓDULO 3: Sismicidad en Infraestructura Minera}
...
Este documento contiene los apuntes del ramo MÓDULO 3: Sismicidad en Infraestructura Minera (DDPDICICM03).
