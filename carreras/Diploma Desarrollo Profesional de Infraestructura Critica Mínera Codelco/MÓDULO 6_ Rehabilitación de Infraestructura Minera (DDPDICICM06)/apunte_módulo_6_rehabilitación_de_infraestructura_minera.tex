...
% --- Datos del documento ---
\title{MÓDULO 6: Rehabilitación de Infraestructura Minera}
...
Este documento contiene los apuntes del ramo MÓDULO 6: Rehabilitación de Infraestructura Minera (DDPDICICM06).
