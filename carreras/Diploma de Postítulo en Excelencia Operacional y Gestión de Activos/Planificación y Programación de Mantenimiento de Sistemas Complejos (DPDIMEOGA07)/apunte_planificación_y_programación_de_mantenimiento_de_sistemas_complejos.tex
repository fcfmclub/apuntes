...
% --- Datos del documento ---
\title{Planificación y Programación de Mantenimiento de Sistemas Complejos}
...
Este documento contiene los apuntes del ramo Planificación y Programación de Mantenimiento de Sistemas Complejos (DPDIMEOGA07).
