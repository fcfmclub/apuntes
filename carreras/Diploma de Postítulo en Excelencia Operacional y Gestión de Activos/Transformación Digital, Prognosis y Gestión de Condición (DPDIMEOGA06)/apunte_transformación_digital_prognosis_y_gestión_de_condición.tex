...
% --- Datos del documento ---
\title{Transformación Digital, Prognosis y Gestión de Condición}
...
Este documento contiene los apuntes del ramo Transformación Digital, Prognosis y Gestión de Condición (DPDIMEOGA06).
