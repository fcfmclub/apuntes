...
% --- Datos del documento ---
\title{Control de Vibraciones en Proyectos Ferroviarios y de Metro}
...
Este documento contiene los apuntes del ramo Control de Vibraciones en Proyectos Ferroviarios y de Metro (DPDICPFM10).
