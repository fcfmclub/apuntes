...
% --- Datos del documento ---
\title{Requisitos Operacionales en Proyectos Ferroviarios y de Metro}
...
Este documento contiene los apuntes del ramo Requisitos Operacionales en Proyectos Ferroviarios y de Metro (DPDICPFM03).
