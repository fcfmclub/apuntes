...
% --- Datos del documento ---
\title{Sistemas de Climatización: Componentes y Principios de Funcionamiento}
...
Este documento contiene los apuntes del ramo Sistemas de Climatización: Componentes y Principios de Funcionamiento (DPDIMCLI03).
