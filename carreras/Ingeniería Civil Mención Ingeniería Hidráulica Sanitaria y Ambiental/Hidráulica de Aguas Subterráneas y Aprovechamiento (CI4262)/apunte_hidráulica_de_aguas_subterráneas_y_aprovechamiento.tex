...
% --- Datos del documento ---
\title{Hidráulica de Aguas Subterráneas y Aprovechamiento}
...
Este documento contiene los apuntes del ramo Hidráulica de Aguas Subterráneas y Aprovechamiento (CI4262).
